var ActivitiesAndRecordsViewModel = function (placeHolder, view, user, ignoreMap, doNotInit, doNotStoreFacetFiltering, columnConfig, facetConfig, boundElementSelector, activityView) {
    var self = this;
    ...
    self.load = function (data, page) {
        ...
        activities = $.map(activities ? activities : [], function (activity, index) {
            ...
            else return new ActivityRecordViewModel(activity);
        });
