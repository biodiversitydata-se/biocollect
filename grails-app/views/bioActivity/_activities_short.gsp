...
<asset:script type="text/javascript">
    ...
    function initialiseData(view) {
        ...
        activitiesAndRecordsViewModel = new ActivitiesAndRecordsViewModel('data-result-placeholder', view, user, ${showSites}, false, ${doNotStoreFacetFilters?:false}, columnConfig);
