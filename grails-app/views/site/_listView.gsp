<bc:koLoading>
    ...
    <div data-bind="visible: name">
        <div class="pull-right margin-right-20">
            ...
            <a data-bind="attr:{href:getSiteEditUrl(${hubConfig?.isSystematicMonitoring})},visible: canEdit" class="margin-left-10"><i class="fa fa-edit" title="${message(code: 'site.list.edit')}"></i></a>
