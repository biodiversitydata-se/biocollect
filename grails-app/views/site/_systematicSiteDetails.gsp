...
<div class="well" id="sitemap">
    ...
    <g:render template="/site/systematicSiteDefinition" model="${[showPolygon: true, showLine: true, showMyLocation: true, showAllowSearchLocationByAddress: false, showAllowSearchRegionByAddress: false, showMarker: true, allowDetails: params.allowDetails]}"/>
