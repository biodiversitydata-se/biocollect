...
<button id="loadProjectActivities" class="btn btn-primary btn-large">Load existing surveys</button>
...
<asset:script type="text/javascript">
    $(document).ready(function() {
        ...
        function createProjectActivitiesVM(data){
        ...
        function getProjectActivitySettings(){
            $.ajax({
                url: fcConfig.loadProjectActivitiesUrl,
                type: "GET",
